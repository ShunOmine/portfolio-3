			...
			<div>
				<nav className="nav">
					<ul className="nav_list">
						<li className="products"><Link to="/products" className="nav_link"><i className="far fa-file-alt"></i></Link></li>
						<li className="skills"><Link to="/skills" className="nav_link now"><i className="far fa-address-card"></i></Link></li>
